...
# Screen #2 - Pipeline Detail Screen
    def pipeline_Detail_Screen(self,event):
        ...
        self.detail_label_2=ttk.Label(self.frame_left_upper,text="Client: ",background="white")
        self.detail_label_2.grid(column=0,row=1,sticky='e')
        self.detail_label_3=ttk.Label(self.frame_left_upper,text="Pipeline License Number: ",background="white")
        self.detail_label_3.grid(column=0,row=2,sticky='e')
        self.detail_label_4=ttk.Label(self.frame_left_upper,text="Inspection Date: ",background="white")
        self.detail_label_4.grid(column=0,row=3,sticky='e')
        self.detail_label_5=ttk.Label( self.frame_left_lower,text="Pipeline Static Design Details",background="white", font="Arial 14 bold",width=30,anchor="n",justify='center')
        self.detail_label_5.grid(column=0,row=4,columnspan=2)
        self.detail_label_6=ttk.Label( self.frame_left_lower,text="Nominal OD: ",background="white")
        self.detail_label_6.grid(column=0,row=5,sticky='e')
        self.detail_label_7=ttk.Label( self.frame_left_lower,text="Nominal Wall Thickness (WT): ",background="white")
        self.detail_label_7.grid(column=0,row=6,sticky='e')
        self.detail_label_8=ttk.Label( self.frame_left_lower,text="Corrosion/Inspection Allowance: ",background="white")
        self.detail_label_8.grid(column=0,row=7,sticky='e')
        self.detail_label_9=ttk.Label( self.frame_left_lower,text="SMYS: ",background="white")
        self.detail_label_9.grid(column=0,row=8,sticky='e')
        self.detail_label_10=ttk.Label( self.frame_left_lower,text="Code Design Factor, F: ",background="white")
        self.detail_label_10.grid(column=0,row=9,sticky='e')
        self.detail_label_11=ttk.Label( self.frame_left_lower,text="Location Factor, L: ",background="white")
        self.detail_label_11.grid(column=0,row=10,sticky='e')
        self.detail_label_12=ttk.Label( self.frame_left_lower,text="Joint Factor, L: ",background="white")
        self.detail_label_12.grid(column=0,row=11,sticky='e')
        self.detail_label_13=ttk.Label( self.frame_left_lower,text="Temperature Factor, T: ",background="white")
        self.detail_label_13.grid(column=0,row=12,sticky='e')
        self.detail_label_14=ttk.Label( self.frame_left_lower,text="License Pressure (kPa): ",background="white")
        self.detail_label_14.grid(column=0,row=13,sticky='e')
        self.detail_label_15=ttk.Label( self.frame_left_lower,text="Normal Operating Pressure (kPa): ",background="white")
        self.detail_label_15.grid(column=0,row=14,sticky='e')
        self.detail_label_16=ttk.Label( self.frame_left_lower,text="Maximum Possible Pressure (kPa): ",background="white")
        ...
        self.detail_label_17=ttk.Label(self.frame_middle,text="PL 100 Data",background="white", font="Arial 14 bold",width=20,anchor="n",justify='center')
        self.detail_label_17.grid(column=3,row=4,columnspan=2)
        self.detail_label_18=ttk.Label(self.frame_middle,text="Substance: ",background="white")
        self.detail_label_18.grid(column=3,row=5,sticky='e')
        self.detail_label_19=ttk.Label(self.frame_middle,text="To: ",background="white")
        self.detail_label_19.grid(column=3,row=6,sticky='e')
        self.detail_label_20=ttk.Label(self.frame_middle,text="From: ",background="white")
        self.detail_label_20.grid(column=3,row=7,sticky='e')
        self.detail_label_21=ttk.Label(self.frame_middle,text="Length (km): ",background="white")
        self.detail_label_21.grid(column=3,row=8,sticky='e')
        self.detail_label_22=ttk.Label(self.frame_middle,text="Material: ",background="white")
        self.detail_label_22.grid(column=3,row=9,sticky='e')
        self.detail_label_23=ttk.Label(self.frame_middle,text="Material Type: ",background="white")
        self.detail_label_23.grid(column=3,row=10,sticky='e')
        self.detail_label_24=ttk.Label(self.frame_middle,text="Grade: ",background="white")
        self.detail_label_24.grid(column=3,row=11,sticky='e')
        self.detail_label_25=ttk.Label(self.frame_middle,text="Stress: ",background="white")
        self.detail_label_25.grid(column=3,row=12,sticky='e')
        self.detail_label_26=ttk.Label(self.frame_middle,text="MOP: ",background="white")
        self.detail_label_26.grid(column=3,row=13,sticky='e')
        self.detail_label_27=ttk.Label(self.frame_middle,text="H2S: ",background="white")
        self.detail_label_27.grid(column=3,row=14,sticky='e')
        self.detail_label_28=ttk.Label(self.frame_middle,text="Age: ",background="white")
        ...
        self.detail_label_29=ttk.Label(self.frame_right,text="Env Factors",background="white", font="Arial 14 bold",anchor="n",justify='center')
        self.detail_label_29.grid(column=5,row=4,columnspan=2)
        self.detail_label_30=ttk.Label(self.frame_right,text="Cased Crossings: ",background="white")
        self.detail_label_30.grid(column=5,row=5,sticky='e')
        self.detail_label_31=ttk.Label(self.frame_right,text="Road Crossings: ",background="white")
        self.detail_label_31.grid(column=5,row=6,sticky='e')
        self.detail_label_32=ttk.Label(self.frame_right,text="Railway Crossings: ",background="white")
        self.detail_label_32.grid(column=5,row=7,sticky='e')
        self.detail_label_33=ttk.Label(self.frame_right,text="Station Crossings: ",background="white")
        self.detail_label_33.grid(column=5,row=8,sticky='e')
        self.detail_label_34=ttk.Label(self.frame_right,text="Other Crossings: ",background="white")
        self.detail_label_34.grid(column=5,row=9,sticky='e')
        self.detail_label_35=ttk.Label(self.frame_right,text="Substance Class: ",background="white")
        self.detail_label_35.grid(column=5,row=10,sticky='e')
        self.detail_label_36=ttk.Label(self.frame_right,text="Pipeline Class: ",background="white")
        self.detail_label_36.grid(column=5,row=11,sticky='e')
        self.detail_label_37=ttk.Label(self.frame_right,text="Seam Type: ",background="white")
        self.detail_label_37.grid(column=5,row=12,sticky='e')
        
        # Column 6 User Input for Env Factors
        self.detail_label_29_input=ttk.Combobox(self.frame_right,value=["Yes","No"],background="white")
        self.detail_label_29_input.grid(column=6,row=5)
        self.detail_label_30_input=ttk.Combobox(self.frame_right,value=["Yes","No"],background="white")
        self.detail_label_30_input.grid(column=6,row=6)
        self.detail_label_31_input=ttk.Combobox(self.frame_right,value=["Yes","No"],background="white")
        self.detail_label_31_input.grid(column=6,row=7)
        self.detail_label_32_input=ttk.Combobox(self.frame_right,value=["Yes","No"],background="white")
        self.detail_label_32_input.grid(column=6,row=8)
        self.detail_label_33_input=ttk.Combobox(self.frame_right,value=["Yes","No"],background="white")
        self.detail_label_33_input.grid(column=6,row=9)
        self.detail_label_34_input=ttk.Combobox(self.frame_right,value=["Gas","Multiphase"],background="white")
        self.detail_label_34_input.grid(column=6,row=10)
        self.detail_label_35_input=ttk.Combobox(self.frame_right,background="white",value=["None","10 or fewer dwelling units","11 to 46 dwellings","46 or more dwelling units","prevelance of buildings intended for oiccupancy with 4 or more stories"])
        self.detail_label_35_input.grid(column=6,row=11)
        self.detail_label_36_input=ttk.Combobox(self.frame_right,background="white",value=["Seamless","Electric Welder","Submerged Arc Welded","Continuous Weld"])
...
# Screen #3 - ILI Data Display
    #def iliData_Display()
    # submit_ILI4Review - Pull ComboBox selection and send to excel sorting. Chance window for display.
